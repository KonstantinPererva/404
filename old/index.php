...
<div class="main">
  ...
  <section data-slide="start" class="start flex-box slide">
    ...
    <header class="flex-box">
      ...
      <div class="phone" data-phone="+380938476795">+38 093 84 76 795</div>
      <div class="social">
      ...
      <div class="menu">
        <nav data-animated="fadeInLeft" class="flex-box my-animate">
          <ul>
            ...
            <li data-index-slide="7"><a href="#start-map">Карта стартов</a></li>
          ...
          <div class="nav-slider">
            <!--<span><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 44.238 44.238"
     xml:space="preserve">
    <g>
      ...
      <path d="M24.667,29.884c-0.192,0-0.384-0.072-0.53-0.22l-7.328-7.334c-0.292-0.293-0.292-0.768,0-1.061l7.328-7.333
        ...
        C25.051,29.812,24.859,29.884,24.667,29.884z"/>
            ...
            <span>
              <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 44.236 44.236" xml:space="preserve">
      ...
      <div class="slider-content">
        ...
        <p data-animated="fadeIn" class="slider-text my-animate delay-1s faster">Team 404 - команда в которой каждый,
          вне зависимости от исходного уровня, под руководствои профессиональных тренеров, сможет стать Ironman,
          марафонцем, пловцом и просто здоровым счастливым человеком.</p>
        <div class="slider-menu">
          <div>
            <button data-index-slide="2" type="button" class="white-btn">
              <a href="#team">Подробнее</a>
            </button>
          </div>
          <!--<div><p><span>▶</span> Посмотреть фильм о команде</p></div>-->
        </div>
      </div>
        ...
        <div class="triathlon-description">
          ...
          <div class="ironman-block">
            ...
            <div class="iroman-distances">
              <div><img src="/new/img/swim.png" alt="">
                <span>3,9 км</span>
              </div>
              <div><img src="/new/img/velo.png" alt="">
                <span>180 км</span>
              </div>
              <div><img src="/new/img/run.png" alt="">
                <span>42,2 км</span>
              </div>
            </div>
