...
<div class="main">
      ...
      <div class="content">
        ...
        <div class="start-box">
          ...
          <div class="start-list">
            <div class="start-list__item">
              <div class="start-descr">
                <span class="start-descr__ico">
                  <img src="img/svg/man.svg" alt="icon" />
                </span>

                <span class="start-descr__text">Подготовка <span class="start-descr__text_mark">под ключ</span></span>
              </div>
            </div>
            <div class="start-list__item">
              <div class="start-descr">
                <span class="start-descr__ico">
                  <img src="img/svg/date.svg" alt="icon" />
                </span>

                <span class="start-descr__text">Марафон за полгода с <span class="start-descr__text_mark">минимального уровня</span></span>
              </div>
            </div>
            ...
            <div class="start-list__item">
              <div class="start-descr">
                <span class="start-descr__ico">
                  <img src="img/svg/medal.svg" alt="icon" />
                </span>

                <span class="start-descr__text">Гарантия достижения цели <span class="start-descr__text_mark">100%</span></span>
              </div>
            </div>
          </div>

          <div class="start-box__row">
  ...
  <section data-slide="directions" class="directions flex-box slide">
    ...
    <span class="directions-substrate">
      <span class="directions-substrate__run active"></span>
    </span>
  </section>
  ...
  <section data-slide="cost" class="cost flex-box slide">
    <div class="name-block">
      <span class="name-block__title">Стоимость</span>
    </div>
        ...
        <div class="flex-box cost-box">
          ...
          <div class="cost-description">
            ...
            <ul class="cost-list">
              ...
              <li>тренеры выступают и тренируются вместе с вами</li>
            </ul>
